...
mod tests {
    ...
    use crate::{core_::{debug::debug_session::{Backtrace, DebugSession, LogLevel}, net::protocols::jds::jds_serialize::JdsSerialize, point::{point::{Direction, Point}, point_type::PointType}, status::status::Status, types::bool::Bool}, tcp::steam_read::StreamRead}; 
    ...
    fn test_JdsSerialize() {
        ...
        let testData = [
            ...
            (
                format!(r#"{{"type": "Float", "name": "{}", "value": -1.7976931348623157e308, "status": 0, "timestamp":"{}"}}"#, 
            ...
            (
                format!(r#"{{"type": "String","name": "{}", "value": "~!@#$%^&*()_+`1234567890-=","status": 0, "timestamp":"{}"}}"#, 
