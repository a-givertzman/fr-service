...
mod tests {
    ...
    use crate::{core_::{net::protocols::jds::jds_serialize::JdsSerialize, point::{point::{Cot, Point}, point_type::PointType}, status::status::Status, types::bool::Bool}, tcp::steam_read::StreamRead}; 
    ...
    fn test_JdsSerialize() {
        ...
        let testData = [
            ...
            (
                ...
                name, tsStr(ts)), PointType::Bool(Point::new(txId, name, Bool(true), Status::Ok, Cot::Write, ts))
            ),
            (
            ...
            (
                ...
                name, tsStr(ts)), PointType::Int(Point::new(txId, name, -9223372036854775808, Status::Ok, Cot::Write, ts))
            ),
            (
