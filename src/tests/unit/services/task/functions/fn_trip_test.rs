...
fn test_single_int() {
    ...
    let input1 = initEach(0.to_point(0, "point1"));
    let input2 = initEach(0.to_point(0, "point2"));
...
fn test_multiple_float() {
    ...
    // let (initial, switches) = initEach();
    let input1 = initEach(0.0.to_point(0, "point1"));
    let input2 = initEach(0.0.to_point(0, "point2"));
    let mut fnTrip = FnGe::new(
        "test",
        input1.clone(),
        input2.clone(),
