...
use crate::{
    conf::{
        ...
        slmp_client_config::slmp_client_config::SlmpClientConfig,
    },
    core_::{
...
impl SlmpClient {
    ///
    /// Creates new instance of the SlmpClient
    ...
    ///
    /// Reads data slice from the device,
    ...
    ///
    /// Writes Point to the device protocol specific address
